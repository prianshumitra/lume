...
- **Swagger UI**: [http://127.0.0.1:8000/docs](http://127.0.0.1:8000/docs) (Local) or [https://social-media-api-y9fz.onrender.com/docs](https://social-media-api-y9fz.onrender.com/docs) (Live) - Explore and test the API endpoints directly.
- **ReDoc**: [http://127.0.0.1:8000/redoc](http://127.0.0.1:8000/redoc) (Local) or [https://social-media-api-y9fz.onrender.com/redoc](https://social-media-api-y9fz.onrender.com/redoc) (Live) - Clean and structured API documentation.
...
- **Frontend Integration**: A modern, responsive web interface is currently under development and will be integrated soon to provide a complete end-to-end user experience.
